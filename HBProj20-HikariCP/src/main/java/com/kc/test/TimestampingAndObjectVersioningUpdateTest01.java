...
public class TimestampingAndObjectVersioningUpdateTest01 {
	public static void main(String[] args) {
		...
		try(factory;ses){
			...
			if(user==null)
				...
				ses.update(user);
				tx.commit();
				System.out.println("Record lastly updated at :: "+user.getLastUpdated()+", and number of modification done::"+user.getUpdationCount());
			}
